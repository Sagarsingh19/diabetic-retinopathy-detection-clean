...
st.image("./streamlit_app/assets/retina_cover.png")
st.markdown(
...
def load_retinopathy_model():
    ...
    url = "https://drive.google.com/uc?id=13ToVMWTOWecpZIqeGO-1ncNvFWGRe9v_"  
...
if use_sample:
    ...
    os.makedirs("output_image", exist_ok=True)  # 👈 ADD THIS
